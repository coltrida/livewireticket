    ...
    <section class="border rounded shadow-lg p-4 w-6/12 bg-gray-200">
        ...
        <form class="my-4" wire:submit.prevent="submit">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="password" class="p-2 rounded border shadow-sm w-full"
                           placeholder="password" autocomplete="password" wire:model="form.password">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="password" class="p-2 rounded border shadow-sm w-full"
                           placeholder="Confirm Password" autocomplete="password" wire:model="form.password_confirmation">
                </div>
            </div>
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="submit" value="Register" class="p-2 bg-gray-800 text-white w-full rounded tracking-widest cursor-pointer">
                </div>
            </div>
        </form>
    </section>
